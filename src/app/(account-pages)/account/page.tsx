    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-grow mt-10 md:mt-0 md:pl-16 max-w-3xl space-y-6">
          ...
          <div>
            <Label>Email</Label>
            <Input className="mt-1.5" defaultValue="example@hotmail.com" />
          </div>
          {/* ---- */}
          ...
          <div className="flex flex-row items-center gap-2">
            <div className="flex-1">
               ...
               <Input className="mt-1.5" defaultValue="12-Y, Bakers Avenue" />
            </div>
            <div className="flex-1">
               <Label>Address two</Label>
               <Input className="mt-1.5" defaultValue="Street 10" />
            </div>
          </div>
          <div className="flex flex-row items-center gap-2">
            <div className="flex-1">
               <Label>City</Label>
               <Input className="mt-1.5" defaultValue="London" />
            </div>
            <div className="flex-1">
               <Label>State</Label>
               <Input className="mt-1.5" defaultValue="Greater London" />
            </div>
          </div>
          <div>
            <Label>Country</Label>
            <Select className="mt-1.5">
              <option value="Male">Bahrain</option>
              <option value="Female">United Arab Emirates</option>
